...
const DEFAULT_P1_SCORES: Record<string, ScoreDelta> = {
  ...
  '23': { submission: 1, masochism: 1 },
  '24': { submission: 1, masochism: 1 },
...
const DEFAULT_P2_SCORES: Record<string, Record<string, ScoreDelta>> = {
  '1': {
    ...
    'C': { psychological: 3 },
    'D': { dominance: 2, submission: 2 },
  },
  '2': {
    'A': { psychological: 3 },
    'B': { masochism: 3, sadism: -2 },
    'C': { psychological: 3, sensory: 1 },
    'D': { sadism: 3, masochism: -2 },
  },
  '3': {
